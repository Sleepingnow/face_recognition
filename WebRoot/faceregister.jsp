        ...
        <body>
            ...
            <div class="content">
	            ...
	            <div class="faceinfo">
	            	...
	            	<p>
	            	请输入学号：<input type="text" id="sid_input" />
	            	</p>
	            	<p>
		        ...
		        $("#btn_submit").click(function(){
			        if(null!=$("#user_input").val() && ""!=$("#user_input").val()){
					    $.ajax({
							...
							type: 'POST',
							data:{img:base64,user:$("#user_input").val(),sid:$("#sid_input").val(),sex:$("#sex_input").val(),course:$("#course_input").val()},
							dataType: 'text',
							async: true,//异步
							timeout: 8000,
							error: function(){
