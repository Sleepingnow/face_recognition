        ...
        <body>
            ...
            <div class="content">
	            ...
	            <div class="faceinfo">
	            	...
	            	<button class="btn_snap">点击抓拍</button></br></br></br>
	            	<p>
	            	请输入姓名：<input type="text" id="user_input" />
	            	</p>
	            	<p>
	            	请输入工号：<input type="text" id="tid_input" />
	            	</p>
	            	<p>
	            	请输入性别：<input type="text" id="sex_input" />
	            	</p>
	            	<p>
	            	请输入班级：<input type="text" id="course_input" />
					</p>	            
	            </div>
       		...
       		function scan(){
		        ...
		        $("#btn_submit").click(function(){
			        if(null!=$("#user_input").val() && ""!=$("#user_input").val()){
					    $.ajax({
							url: '/Face_Recognition/servlet/RegisterTeacher',
							type: 'POST',
							data:{img:base64,user:$("#user_input").val(),tid:$("#tid_input").val(),sex:$("#sex_input").val(),course:$("#course_input").val()},
							dataType: 'text',
							async: true,//异步
							timeout: 8000,
							error: function(){
